...
const cols = PARAMS.numerocolonne;
const rows = PARAMS.numerorighe;
...
const margine = (width - gridw) * 0.5;
    ...
    context.fillStyle = 'rgba(200, ' + noisepos * 255 + ', 100,' + (noisepos + 0.2) +' )';
    //context.lineWidth = 1;
    context.fill();
...
const PARAMS = {
  ...
  colorequadrati: 'rgb(255, 255, 255)',
};
...
pannello.addInput(PARAMS, 'numerorighe', {
  min: 0,
  max: 100,
});
pannello.addInput(PARAMS, 'sfondo');

pannello.addInput(PARAMS, 'colorequadrati', {
});
